      ...
      {geoError && (
        <div className="garbage-map-modal-bg">
          <div className="garbage-map-modal">
            ...
            <div className="garbage-map-error-modal-content">
              <i className="fa-solid fa-circle-exclamation garbage-map-error-modal-icon"></i>
              <div className="garbage-map-error-modal-title">無法取得定位權限</div>
              <div className="garbage-map-error-modal-desc">請允許存取您的位置，才能使用定位功能。</div>
            </div>
          </div>
        </div>
      )}
